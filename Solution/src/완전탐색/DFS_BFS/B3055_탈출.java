...
2차 풀이
설명 :
- 가중치가 없는 그래프에서 최단거리를 구하는 문제이므로 BFS로 접근
- 방문주체는 2종류가 있음. 고슴도치와 물
- 고슴도치가 갈수없는 곳은 1.돌이 있는 곳 2.물이 있는 곳 3.고슴도치 본인이 방문한 곳(중복방문 방지, 최단거리 찾고 있는중)
- 물이 갈 수없는 곳은 1.돌이 있는 곳 2.굴이 있는 곳 3.물 본인이 방문한 곳(중복방문 방지, 최단거리 찾고 있는중)
- 고슴도치와 물이 동시에 움직이는 상황
- 고슴도치는 물이 있는 곳+물이 '있을' 곳에도 방문 불가
-> 큐에 물을 고슴도치보다 먼저 넣어서, 1.물의 노드방문을 고슴도치의 노드방문보다 먼저 진행 2.물 노드방문, 고슴도치 노드방문을 번갈아 진행하면 됨.
 */
import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;
