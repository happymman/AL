...
public class B2042_구간합구하기3 {
    ...
    private static long getSum(int firstIndex, int lastIndex){
        int start = firstIndex+leafNodeStartIndex;
        int end = lastIndex+leafNodeStartIndex;
    ...
    private static void changeValue(int index, long value){
        index = index+leafNodeStartIndex;
        tree[index] = value;
        index /= 2;
        while(index!=0){
